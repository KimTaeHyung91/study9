        ...
        <div>
                        ...
                        <div class="container_visual" style="width: 414px;">
                            <ul class="visual_img detail_swipe">
                                <li class="item" style="width: 414px;">
                                    <img alt="" class="img_thumb" src=${detailItem.file_name}/>
                                    <span class="img_bg"></span>
                                    <div class="visual_txt">
                                        <div class="visual_txt_inn">
                                            <h2 class="visual_txt_tit"> <span>${detailItem.description}</span> </h2>
            ...
            <div class="section_store_details">
                ...
                <div class="store_details close3">
                    <p class="dsc">${detailItem.content}</p>
                </div>
            ...
            <div class="section_event">
                <div class="event_info_box">
                    ...
                    <div class="event_info">
                        <div class="in_dsc">${detailItem.event}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="section_review_list">
                ...
                <a class="btn_review_more" href="/detail/review?id=${detailItem.id}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
            </div>
            <div class="section_info_tab" id="sectionInfo">
                <!-- [D] tab 선택 시 anchor에 active 추가 -->
                <ul class="info_tab_lst">
                    <li class="item active _detail">
                        <a href="#sectionInfo" class="anchor active"> <span>상세정보</span> </a>
                    </li>
                    <li class="item _path">
                        <a href="#sectionInfo" class="anchor"> <span>오시는길</span> </a>
                    </li>
                </ul>
                        ...
                        <div class="detail_info">
                            ...
                            <ul class="detail_info_group">
                                <li class="detail_info_lst">
                                    ...
                                    <p class="in_dsc">${detailItem.content}
                                    </p>
                                </li>
        ...
        <div>
            <div class="review_area">
                <div class="thumb_area">
                    <a href="#" class="thumb" title="이미지 크게 보기"> <%--<img width="90" height="90" class="img_vertical_top" src="" alt="리뷰이미지">--%> </a> <span class="img_count" style="display:none;">1</span>
                </div>
                <h4 class="resoc_name">{description}</h4>
                <p class="review">{comment}</p>
            </div>
            <div class="info_area">
                <div class="review_info"> <span class="grade">{score}</span> <span class="name">dbfl****</span> <span class="date">{create_date}</span> </div>
            </div>
        </div>
    </li>
</script>
