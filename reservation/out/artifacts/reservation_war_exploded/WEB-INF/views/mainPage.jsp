        ...
        <div class="section_visual">
            <div class="group_visual">
                <div class="container_visual">
                    <div class="prev_e" style="display:block;">
                        <div class="prev_inn">
                            <a href="#" class="btn_pre_e" title="이전"> <i class="spr_book_event spr_event_pre">이전</i> </a>
                        </div>
                    </div>
                    <div class="nxt_e" style="display:block;">
                        <div class="nxt_inn">
        ...
        <div class="section_event_tab">
            <ul class="event_tab_lst tab_lst_min">
                <c:forEach items="${categoryList}" var="categoryList">
                    <li class="item" data-category="${categoryList.id}">
                        <a class="anchor"> <span>${categoryList.name}</span> </a>
                    </li>
                </c:forEach>
            </ul>
        </div>
...
<script type="rv-template" id="promotionItem">
    <li class="item" id="banner{id}" style="background-image: url('/img/{file_name}'); width: 100%">
...
<script type="rv-template" id="itemList">
    <li class="item">
        <a href="/detail?id={id}&type=detail" class="item_book">
            <div class="item_preview">
                <img alt="{description_alt}" class="img_thumb" src="{file_name}">
